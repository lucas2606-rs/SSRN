...
class HSIDataset:
    def __init__(self, dataset_name, patchsz, random_state):
        ...
        self.y_val, self.x_test, self.y_test = self.splitTrainValTest(self.x_patch, self.y_patch, self.train_val_test, random_state)
    ...
    def splitTrainValTest(self, x_patch, y_patch, train_val_test, random_state):
